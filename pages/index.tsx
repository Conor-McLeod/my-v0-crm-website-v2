          ...
          <div className="max-w-6xl mx-auto">
            <div className="max-w-2xl">
              ...
              <p className="text-lg mb-8 opacity-90">
                With a focus on digital transformation and sales performance improvement, we help businesses by
                providing strategic advice and tailored guidance to get their business processes working and drive
                revenue growth through the use of a CRM system.
              </p>
